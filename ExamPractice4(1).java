/**
 * File: Exam-Practice4.java
 * Class: CSCI 1302
 * Author: Samuel Adeniyi and Reilly Ritzert
 * Created on: Apr 14, 2023
 * Last Modified:  Apr 14, 2023
 * Description: GitHub repository: https://github.com/Sammy-Am-I/Exam-Practice-4
 */
...
public class ExamPractice4 extends Application {
	...
	public void start(Stage primaryStage) {   
		//ComboBox
		Combo.getItems().addAll(altResult,defaultResult);
		Combo.setValue(defaultResult);
		...
		Combo.setOnAction(e -> changeLabels(Combo.getValue()));
	...
	private void changeLabels(String string) {
